# SMG Stage 2 — Technical Design

## Booking lifecycle and contention:

### From trader intent through to authoritative inventory allocation

This repository contains my submission for the Stage 2 technical task.

### Start here

**[Main design submission](./booking-lifecycle-and-contention.md)**

Supporting material:

- [(PDF) Rendered submission](./booking-lifecycle-and-contention.pdf)
